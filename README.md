...
O projeto foi estruturado de forma modular para facilitar manutenção e escalabilidade: ├── main.c # fluxo principal do programa ├── tarefa.c/h # lógica de tarefas (lista encadeada) ├── arquivo.c/h # persistência em arquivo ├── UI.c/h # interface do usuário ├── data/ # armazenamento dos dados ├── Makefile # automação de build └── README.md
...
🚀 Como executar
🔧 Compilar
taskkill /F /IM tracker.exe del tracker.exe gcc SRC\main.c SRC\tarefa.c SRC\arquivo.c SRC\UI.c -IInclude -o tracker.exe .\tracker.exe

Exemplo de uso: ===== DAILY TRACKER ===== 1 - Adicionar tarefa 2 - Listar tarefas 3 - Concluir tarefa 4 - Remover tarefa 5 - Progresso 6 - Buscar por data 0 - Sair
